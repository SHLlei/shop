...
<html>
	...
	<head>
		...
		<link href="Person/css/bilstyle.css" rel="stylesheet" type="text/css">

		<script src="Person/js/jquery.min.js" type="text/javascript"></script>
		<script src="Person/js/amazeui.js" type="text/javascript"></script>
				...
				<div class="main-wrap">
					...
					<table width="100%">
						...
						<tbody>
							<tr>
								<td class="img">
									<i><img src="Person/images/songzi.jpg"></i>
								</td>
								<td class="time">
									<p> 2016-01-28
									</p>
